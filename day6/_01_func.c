...
void func2(int num) {
	printf("함수2 사용");
	// void : 리턴값 없음
	// () : int변수가 하나 있으니 사용할 떄 정수값 하나를 넣어줘야함
}

void func3(char c) {
	printf("함수3 사용 \n");
	// void : 리턴값 없음
	// () : char변수 한개가 있으니 사용할 떄 문자 하나를 넣어줘야함
}
...
int main1() {
	...
	int number2 = 5 + 10;			// 출력X, return으로 결과값을 알려줌
	int number = func5(5, 10);

	printf("%d \n", 5+10);					// 5 + 10
	printf("%d \n", func5(5, 10));			// func5(5, 10)

	// func6 : 양수값이 들어어면 Y를 알려주고, 음수값이 들어오면 N를 알려주는 기능
	printf("%c \n", func6(10));				// Y
	printf("%c \n", func6(1));				// Y
	printf("%c \n", func6(-5));				// N

	// 사용할때 넘겨주는 값은 ()에, 사용후에 남겨받을 값은 return에 적어준다.
	char a = '\0';
	a = func6(-3);
	a = 'N';
	
	number = 5 + 10;			// 15가 남음
	number = func6(5, 10);		// 15가 남음
